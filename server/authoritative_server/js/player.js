...
class Player {
    ...
    checkAnimations() {
        ...
        else if (Math.floor(this.physic.body.velocity.x) == 0 && (Math.floor(this.physic.body.velocity.y) == -4)) {
            self.anims['idle']();
        }
...
class LocalPlayer extends Player {
    ...
    sendMove() {
        if ((Math.floor(this.physic.body.velocity.x) != 0) || (Math.floor(this.physic.body.velocity.y) != -4)) {
